...
public class JwtProvider {
    ...
    public String generateAccessToken(Authentication authentication, LoginType loginType) {
        return generateToken(authentication, ACCESS_TOKEN_EXPIRE_TIME, loginType);
    }

    public String generateToken(
            Authentication authentication, Long accessTokenExpiresIn, LoginType loginType
    ) {
